...
var
// psql функция для выборки данных (имя класса для конкретной операции) возвращает данные (mysql)
// heidySQL для sql.
// HTTP запросы. инди HTTP сервер и инди Client (встроены в Delphi)
// Расширить функционал (поле для ввода ID класса) (рассчитаем косинус)
// отдельный скрипт для инициализации БД (уже создана) должен добавить таблицу и данные
